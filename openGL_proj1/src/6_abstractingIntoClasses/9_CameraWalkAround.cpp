...
//calculate delta time to accommodate different processing power
...
int main(void)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            glm::mat4 proj3 = glm::perspective(glm::radians(fov), 960.0f / 540.0f, 0.1f, 100.0f);
            ...
            glm::mat4 mvp = proj3 * cameraView * model10[i];
